...
dotnet run --project "WithLithum.NativeWrapperGen" --configuration Release -v q -- --natives-file "${nativesJsonPath}" --namespace WithLithum.NativeWrapper --class-name Natives --file-name-format "$wrapperPath" --count-time